...
class OfferModel {
  ...
  factory OfferModel.fromJson(Map<String, dynamic> json) {
    return OfferModel(
      ...
      freelancer: json['freelancer'] != null ? FreelancerModel.fromJson(Map<String, dynamic>.from(json['freelancer'])) : null,
      offeredBudget: json['offered_budget'] != null ? int.tryParse(json['offered_budget'].toString()) : null,
      message: json['message'] as String?,
      proposedDeadlineDays: json['proposed_deadline_days'] != null ? int.tryParse(json['proposed_deadline_days'].toString()) : null,
